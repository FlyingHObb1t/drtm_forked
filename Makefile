...
CFLAGS += -I. -I./include $(PLATFORM_CCFLAGS) $(OPT) -I/users/PES0781/frankli/install/cppzmq-4.5.0/include -fpermissive
CXXFLAGS += -I. $(PLATFORM_CXXFLAGS) $(OPT) -std=c++0x -std=c++0x -I/users/PES0781/frankli/install/cppzmq-4.5.0/include -fpermissive
